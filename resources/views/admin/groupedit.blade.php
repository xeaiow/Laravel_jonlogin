    ...
    @section('content')
        ...
        <form action="" method="post">
            ...
            <input type="checkbox" name="finance" value="1" {{ ( $group->finance == '1' ) ? 'checked':'' }}> {{ $func[3]->title }}
            <input type="checkbox" name="server_auth" value="1" {{ ( $group->server_auth == '1' ) ? 'checked':'' }}> {{ $func[4]->title }}
